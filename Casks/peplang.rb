cask "peplang" do
  version "0.1.0"
  sha256 "a5251cc84bc41b190b6a8f1577f280fa11c1719f8e98c78e5269ebb45591ec98"

  # DMG is served by the Go API on api.custo.bot from its `storage/` dir.
  # The release script below uploads the built DMG there on every tag.
  url "https://api.custo.bot/storage/peplang-#{version}.dmg"
  name "peplang"
